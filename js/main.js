...
function doCam(Player){
  ...
  mvMatrix=Translate([
      Player.x*-1+0/*randXm*/+10+FrontBack,
      highVal+UpDown,
      Player.z*-1+/*randZm*/0+10+LeftRight
    ],mvMatrix);
...
function createTankPos(posX,posZ,Team,name){
...
function setIntervals(){
  ...
  setInterval(function(){
    if(MESHES_LOADEDr && MESHES_LOADEDg && MESHES_LOADEDb  ){
        ...
        if(GameObjs.TANKs.length<10 ){

          createTank(GameObjs.Teams[0],"AI-"+randNumber(10000,100));
          createTank(GameObjs.Teams[1],"AI-"+randNumber(10000,100));
          createTank(GameObjs.Teams[2],"AI-"+randNumber(10000,100));
        }
    }
  },3000);
  ...
  var chkLoad=setInterval(function(){
    if(
        ...
        GameObjs.Player=new boxObj(RedtankMesh);
        GameObjs.Player.Team=GameObjs.Teams[0];
        
        GameObjs.Player.x=GameObjs.Teams[0].x;
        GameObjs.Player.z=GameObjs.Teams[0].z;
        GameObjs.Player.Name="Abdullah";
        GameObjs.Player.LifeObj=new boxObj(objs("life","green"));
        
        GameObjs.Player.shotColor=GameObjs.Teams[0].color;
        GameObjs.Player.DefshotColor=GameObjs.Teams[0].color;
        GameObjs.Player.UID+=UID+(new Date().getTime())+(UIDI++);
        GameObjs.Player.setHealth(100);
...
function creatshotfunc(){
  ...
  if(shots_time+800<getSecs(true)){
    if(GameObjs.Player!=null){
      /*if(
        GameObjs.Player.lastTHEAD=="up" || 
        GameObjs.Player.lastTHEAD=="down" 
        ){
        createShot(0,0,GameObjs.Player,GameObjs.Player.shotColor);
        createShot(0,3,GameObjs.Player,GameObjs.Player.shotColor);
        createShot(0,6,GameObjs.Player,GameObjs.Player.shotColor);
        createShot(0,-3,GameObjs.Player,GameObjs.Player.shotColor);
      }else{
        createShot(0,0,GameObjs.Player,GameObjs.Player.shotColor);
        createShot(3,0,GameObjs.Player,GameObjs.Player.shotColor);
        createShot(6,0,GameObjs.Player,GameObjs.Player.shotColor);
        createShot(-3,0,GameObjs.Player,GameObjs.Player.shotColor);
      }*/
      createShot(0,0,GameObjs.Player,GameObjs.Player.shotColor);
